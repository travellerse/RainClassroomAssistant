...
class Config_Ui(object):
    def setupUi(self, Dialog):
        ...
        self.vertical_layout_apprise_settings = QtWidgets.QVBoxLayout(
            self.when_apprise_on
        )
        self.vertical_layout_apprise_settings.setObjectName(
            "vertical_layout_apprise_settings"
        )
        ...
        self.vertical_layout_apprise_events.setObjectName(
            "vertical_layout_apprise_events"
        )
    ...
    def save_config(self, dialog):
        ...
        config["apprise"]["events"][
            "lesson_start"
        ] = self.apprise_event_lesson_start.isChecked()
        config["apprise"]["events"][
            "new_problem"
        ] = self.apprise_event_new_problem.isChecked()
        # 保存
